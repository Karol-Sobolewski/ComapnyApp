...
describe('Department', () => {
    ...
    describe('Updating data', () => {
        ...
        it('should properly update multiple documents with "updateMany" method', async () => {
            await Department.updateMany({}, { $set: { name: 'Department Many' } });
            const updatedDepartments = await Department.find({ name: 'Department Many' });
    ...
    describe('Removing data', () => {
        ...
        it('should properly remove one document with "deleteOne" method', async () => {
            ...
            const deletedDepartmet = await Department.findOne({ name: 'Department #1' });
            expect(deletedDepartmet).to.be.null;
        });
